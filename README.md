...
| [Transkun](https://github.com/Yujia-Yan/Transkun) | Yujia Yan | 钢琴 | ✅ 开源可用（本项目已接入） | PyPI 包自带 `2.0.pt` 权重，偏事件级钢琴转写；当前公开随包 checkpoint 说明为无 pedal extension |
...
| [YourMT3+](https://github.com/mimbres/YourMT3) | KAIST / C4DM | 多乐器 | PerceiverTF 编码器 + 多通道解码 + MoE 增强；论文对比表中 Slakh Multi F1 为 74.84 |
| [MR-MT3](https://github.com/gudgud96/MR-MT3) | Sony AI + BandLab | 多乐器 | MT3 增强版，引入 memory retention 抑制 instrument leakage；论文报告在 Slakh2100 多项指标优于 MT3 |
| [PerceiverTF](https://arxiv.org/abs/2306.10785) | Lu et al.（ICASSP 2023） | 多乐器/人声 | 时频感知 Perceiver 架构；论文报告在多个公开基准上优于 MT3/SpecTNT（研究复现路线） |
| [Jointist](https://arxiv.org/abs/2302.00286) | Cheuk et al. | 多乐器 | 转写+分离联合学习路线；论文报告在流行音乐场景优于 MT3，适合与 stem 管线结合评估 |
...
> **趋势总结**：截至 2026 年初，同领域开源强模型已不止三项；多乐器 AMT 主要沿 MT3/YourMT3+ 系列与预训练编码器增强路线并行发展。钢琴转写开源成熟度仍更高，跨数据集、跨口径的可复现对比仍在完善中。
